...
```
```CMD
CREATE PLUGGABLE DATABASE APPDB ADMIN USER pdbadmin IDENTIFIED BY LabMachine4@Training FILE_NAME_CONVERT=('/opt/oracle/oradata/FREE/pdbseed/', '/opt/oracle/oradata/FREE/appdb/');
```
```CMD
