...
```CMD
docker run -d --name maximo-dms -p 3025:25 -p 3143:143 --hostname maximo --domainname maximo.com -v maximo-config:/Users/jawahar/codersyacht/docker-mailserver/  mailserver/docker-mailserver:latest
```
