...
```CMD
sudo openssl req -newkey rsa:2048 -new -x509 -days 3650 -nodes -subj '/C=IN/ST=KA/L=BL/O=Personal/OU=Personal/emailAddress=md.jawahar@ibm.com/CN=<host>' -out mongodb-cert.crt -keyout mongodb-cert.key
```
